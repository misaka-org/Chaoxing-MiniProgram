...
export default function Home() {
  return (
    <main className="shadow-lg bg-white rounded-lg w-full max-w-md mx-auto p-[20px] m-[20vh] border-[1px] border-gray-200">
      <h1 className="text-[30px] font-bold text-center m-[20px]">学习通登录</h1>

      <img src={二维码} width={200} height={200} alt="御坂学习小程序" className="rounded-full mx-auto mt-4" />
