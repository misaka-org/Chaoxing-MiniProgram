        ...
        <div className="p-[20px] w-full mt-[10vh]">
            <main className="shadow-lg bg-white rounded-lg w-full max-w-md mx-auto p-[20px] border-[1px] border-gray-200">
                ...
                <p className='text-sm font-bold text-gray-400 text-center m-[8px]'>
                    <a className="text-sm font-bold text-blue-600 text-center m-[8px] mb-[20px] underline" href='./courses'>课程列表（需先登录）</a>
                    <a className="text-sm font-bold text-blue-600 text-center m-[8px] mb-[20px] underline" href='./image' target="_blank">超星图床（需先登录）</a>
                </p>
